...
<template>
  <div class=" max-w-screen-xl mx-auto">
    <div class=" my-5 py-2">
      ...
      <div role="status"
        v-if="loadingDetail"
        class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center relative z-0">
        <div class="flex items-center justify-center h-[600px] bg-gray-300 rounded w-[550px] dark:bg-gray-700">
